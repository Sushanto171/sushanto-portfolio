    ...
    <section id="contact" className=" pt-18">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 ">
          ...
          <div className="md:col-span-2 h-full">
            <form className="rounded-2xl border bg-card p-8 shadow-sm space-y-6 h-full">
              ...
              <Button
                type="button"
                className="w-full rounded-lg bg-primary px-6 py-3.5 text-sm font-semibold text-primary-foreground transition active:scale-[0.98]"
              >
                Send Message
              </Button>
            </form>
